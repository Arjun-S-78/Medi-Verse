          ...
          Expanded(
            child: ListView(
              ...
              children: [
                ...
                _buildNavItem(3, Icons.person_search_outlined, 'Find Doctors', isDark, onTap: () => context.push(RouteNames.hospitalSearch)),
                _buildNavItem(4, Icons.domain_outlined, 'Hospitals', isDark, onTap: () => context.go(RouteNames.hospitalSearch)),
                _buildNavItem(5, Icons.calendar_month_outlined, 'Appointments', isDark, onTap: () => context.push(RouteNames.triageAssess)),
  ...
  Widget _buildQuickActionsColumn(bool isDark) {
    final actions = [
      ...
      },
      {
        ...
        'onTap': () => context.push(RouteNames.hospitalSearch),
      },
      {
        'title': 'Book\nAppointment',
